...
var newConnection = func(
	...
	s.sentPacketHandler = ackhandler.NewSentPacketHandler(
		...
		s.qlogger,
		s.logger,
		s.config.LossDetectionPacketThreshold,
		s.config.LossDetectionTimeThreshold,
	)
...
func (c *Conn) preSetup() {
	...
	c.receivedPacketHandler = *ackhandler.NewReceivedPacketHandler(c.logger, c.config.AckGapSettleDelay)
