...
//
//	mockgen -typed -package quic -self_package github.com/philwo/quic-go -self_package github.com/philwo/quic-go -destination mock_packetconn_test.go net PacketConn
//
