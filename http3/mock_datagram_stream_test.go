...
// Source: github.com/philwo/quic-go/http3 (interfaces: DatagramStream)
//
// Generated by this command:
//
//	mockgen -typed -build_flags=-tags=gomock -mock_names=DatagramStream=MockDatagramStream -package http3 -destination mock_datagram_stream_test.go github.com/philwo/quic-go/http3 DatagramStream
//
